...
<header>
  <div id="navigation">
	...
	<div class="container" style="width: 30rem;">
        ...
        <input type='password' name='password1' id='password' minlength ="8" maxlength="50" required/>
        <br>
        ...
        <br><br>
          ...
          <br> <p1>Please select your preferred gender(s)!</p>
            ...
            <br><div class="text-center"><button type="submit" class="btn btn-primary btn-lg" name="reg_user">Submit</button><button type="reset" class="btn btn-primary btn-lg">Reset</button></div><br>
        </fieldset>
    </form> 
